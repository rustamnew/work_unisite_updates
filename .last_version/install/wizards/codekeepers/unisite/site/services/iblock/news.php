...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--TAGS--#--'.GetMessage("WZD_OPTION_2").'--;--edit5--#--'.GetMessage("WZD_OPTION_3").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_4").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_5").'--;--edit6--#--'.GetMessage("WZD_OPTION_6").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_7").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_8").'--;--cedit1--#--'.GetMessage("WZD_OPTION_9").'--,--ID--#--ID--,--ACTIVE--#--'.GetMessage("WZD_OPTION_10").'--,--SORT--#--'.GetMessage("WZD_OPTION_11").'--,--CODE--#--'.GetMessage("WZD_OPTION_12").'--;--";}'));


CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("news_IBLOCK_ID" => $iblockID));
