...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PROPERTY_'.$arProperty["price"].'--#--'.GetMessage("WZD_OPTION_2").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["icon"].'--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["promo"].'--#--'.GetMessage("WZD_OPTION_5").'--,--PROPERTY_'.$arProperty["reviews"].'--#--'.GetMessage("WZD_OPTION_6").'--,--PROPERTY_'.$arProperty["team"].'--#--'.GetMessage("WZD_OPTION_7").'--;--edit5--#--'.GetMessage("WZD_OPTION_8").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_9").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_10").'--;--edit6--#--'.GetMessage("WZD_OPTION_11").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_12").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_13").'--;--cedit1--#--'.GetMessage("WZD_OPTION_14").'--,--ID--#--'.GetMessage("WZD_OPTION_15").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_16").'--,--SORT--#--'.GetMessage("WZD_OPTION_17").'--,--CODE--#--'.GetMessage("WZD_OPTION_18").'--;--";}'));
