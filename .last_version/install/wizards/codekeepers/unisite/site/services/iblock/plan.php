...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/plan.xml"; 
$iblockCode = "plan_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PROPERTY_'.$arProperty["color"].'--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["cost"].'--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["currency"].'--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["period"].'--#--'.GetMessage("WZD_OPTION_5").'--,--PROPERTY_'.$arProperty["subtitle"].'--#--'.GetMessage("WZD_OPTION_6").'--,--edit1_csection1--#----'.GetMessage("WZD_OPTION_7").'--,--PROPERTY_'.$arProperty["feature1"].'--#--'.GetMessage("WZD_OPTION_8").'--,--PROPERTY_'.$arProperty["feature2"].'--#--'.GetMessage("WZD_OPTION_9").'--,--PROPERTY_'.$arProperty["feature3"].'--#--'.GetMessage("WZD_OPTION_10").'--,--PROPERTY_'.$arProperty["feature4"].'--#--'.GetMessage("WZD_OPTION_11").'--,--PROPERTY_'.$arProperty["feature5"].'--#--'.GetMessage("WZD_OPTION_12").'--;--cedit1--#--'.GetMessage("WZD_OPTION_13").'--,--ID--#--'.GetMessage("WZD_OPTION_14").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_15").'--,--SORT--#--'.GetMessage("WZD_OPTION_16").'--,--CODE--#--'.GetMessage("WZD_OPTION_17").'--;--";}'));


CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("plan_IBLOCK_ID" => $iblockID));
