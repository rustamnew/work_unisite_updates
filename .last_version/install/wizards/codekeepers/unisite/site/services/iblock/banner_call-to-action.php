...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/banner_call-to-action.xml"; 
$iblockCode = "banner_call-to-action_".WIZARD_SITE_ID;
$iblockType = "banners"; 
...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["title"].'--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["subtitle"].'--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["url"].'--#--'.GetMessage("WZD_OPTION_5").'--,--PROPERTY_'.$arProperty["text"].'--#--'.GetMessage("WZD_OPTION_6").'--;--cedit1--#--'.GetMessage("WZD_OPTION_7").'--,--ID--#--'.GetMessage("WZD_OPTION_8").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_9").'--,--SORT--#--'.GetMessage("WZD_OPTION_10").'--,--CODE--#--'.GetMessage("WZD_OPTION_11").'--;--";}'));


CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("banner_call-to-action_IBLOCK_ID" => $iblockID));
