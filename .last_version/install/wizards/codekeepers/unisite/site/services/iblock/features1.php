...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/features1.xml"; 
$iblockCode = "features1_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PROPERTY_'.$arProperty["icon"].'--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["url"].'--#--'.GetMessage("WZD_OPTION_8").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_3").'--;--cedit1--#--'.GetMessage("WZD_OPTION_4").'--,--ID--#--ID--,--ACTIVE--#--'.GetMessage("WZD_OPTION_5").'--,--SORT--#--'.GetMessage("WZD_OPTION_6").'--,--CODE--#--'.GetMessage("WZD_OPTION_7").'--;--";}'));


CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("features1_IBLOCK_ID" => $iblockID));
