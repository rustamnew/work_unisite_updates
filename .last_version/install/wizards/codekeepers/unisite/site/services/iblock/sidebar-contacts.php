...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/sidebar-contacts.xml"; 
$iblockCode = "sidebar-contacts_".WIZARD_SITE_ID;
$iblockType = "widgets"; 
...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--edit1_csection2--#----'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["phone_show"].'--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["phone_title"].'--#--'.GetMessage("WZD_OPTION_4").'--,--edit1_csection1--#----'.GetMessage("WZD_OPTION_5").'--,--PROPERTY_'.$arProperty["email_show"].'--#--'.GetMessage("WZD_OPTION_6").'--,--PROPERTY_'.$arProperty["email_title"].'--#--'.GetMessage("WZD_OPTION_7").'--,--edit1_csection3--#----'.GetMessage("WZD_OPTION_8").'--,--PROPERTY_'.$arProperty["address_show"].'--#--'.GetMessage("WZD_OPTION_9").'--,--PROPERTY_'.$arProperty["address_title"].'--#--'.GetMessage("WZD_OPTION_10").'--,--edit1_csection4--#----'.GetMessage("WZD_OPTION_11").'--,--PROPERTY_'.$arProperty["text"].'--#--'.GetMessage("WZD_OPTION_12").'--,--PROPERTY_'.$arProperty["url"].'--#--'.GetMessage("WZD_OPTION_13").'--;--cedit1--#--'.GetMessage("WZD_OPTION_14").'--,--ID--#--'.GetMessage("WZD_OPTION_15").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_16").'--,--SORT--#--'.GetMessage("WZD_OPTION_17").'--,--CODE--#--'.GetMessage("WZD_OPTION_18").'--;--";}'));


CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("sidebar-contacts_IBLOCK_ID" => $iblockID));
