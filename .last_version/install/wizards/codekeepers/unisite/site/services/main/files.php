...
*/
	...
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."career/", Array("SITE_DIR" => WIZARD_SITE_DIR));
	...
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."license/", Array("SITE_DIR" => WIZARD_SITE_DIR));
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."offer/", Array("SITE_DIR" => WIZARD_SITE_DIR));
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."pricing/", Array("SITE_DIR" => WIZARD_SITE_DIR));
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."privacy/", Array("SITE_DIR" => WIZARD_SITE_DIR));
	...
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."shop/", Array("SITE_DIR" => WIZARD_SITE_DIR));
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."team/", Array("SITE_DIR" => WIZARD_SITE_DIR));
...
$arNewUrlRewrite = array(
	...
	array (
		'CONDITION' => '#^'.WIZARD_SITE_DIR.'career/#',
		'RULE' => '',
		'ID' => 'bitrix:news',
		'PATH' => ''.WIZARD_SITE_DIR.'career/index.php',
	),

	array (
		'CONDITION' => '#^'.WIZARD_SITE_DIR.'pricing/#',
		'RULE' => '',
		'ID' => 'bitrix:news',
		'PATH' => ''.WIZARD_SITE_DIR.'pricing/index.php',
	),
	...
	array (
		'CONDITION' => '#^'.WIZARD_SITE_DIR.'shop/#',
		'RULE' => '',
		'ID' => 'bitrix:news',
		'PATH' => ''.WIZARD_SITE_DIR.'shop/index.php',
	),

	array (
		'CONDITION' => '#^'.WIZARD_SITE_DIR.'team/#',
		'RULE' => '',
		'ID' => 'bitrix:news',
		'PATH' => ''.WIZARD_SITE_DIR.'team/index.php',
	),
