...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function ShowStep()
	{
		...
		$wizard->SetVar("templateID", "unisite");
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$siteLogo = $this->GetFileContentImgSrc(WIZARD_SITE_PATH."include/company_name.php", "/bitrix/wizards/bitrix/unisite/site/templates/unisite/lang/".LANGUAGE_ID."/logo.gif");
		if (!file_exists(WIZARD_SITE_PATH."include/logo.gif"))
			$siteLogo = "/bitrix/wizards/bitrix/unisite/site/templates/unisite/lang/".LANGUAGE_ID."/logo.gif";
...
class FinishStep extends CFinishWizardStep
{
	function ShowStep()
	{
		...
		$file = fopen($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/codekeepers.unisite/install/db/install_.sql", 'r');
        $text_old = fread($file, filesize($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/codekeepers.unisite/install/db/install_.sql"));
        $wizard =& $this->GetWizard();
		$text_old = str_replace('site_id', $wizard->GetVar("siteID"), $text_old);
        $text_old = str_replace('form_id', $FORM_ID, $text_old);
        fclose($file);
        $file = fopen($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/codekeepers.unisite/install/db/install.sql", 'w');
