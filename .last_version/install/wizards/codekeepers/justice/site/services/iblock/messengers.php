...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/messengers.xml"; 
$iblockCode = "messengers_".WIZARD_SITE_ID;
$iblockType = "settings";
...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--Элемент--,--NAME--#--'.GetMessage("WZD_OPTION_0").'--,--PROPERTY_'.$arProperty["icon"].'--#--'.GetMessage("WZD_OPTION_1").'--,--PROPERTY_'.$arProperty["url"].'--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["color_background"].'--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["color_icon"].'--#--'.GetMessage("WZD_OPTION_4").'--;--cedit1--#--'.GetMessage("WZD_OPTION_5").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_6").'--,--SORT--#--'.GetMessage("WZD_OPTION_7").'--,--CODE--#--'.GetMessage("WZD_OPTION_8").'--;--";}'));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("MESSENGERS_IBLOCK_ID" => $iblockID));
