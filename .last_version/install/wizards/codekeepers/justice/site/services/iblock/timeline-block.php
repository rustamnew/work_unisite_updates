...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/timeline-block.xml"; 
$iblockCode = "timeline-block_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PROPERTY_'.$arProperty["title"].'--#--'.GetMessage("WZD_OPTION_2").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["show_timeline"].'--#--'.GetMessage("WZD_OPTION_4").'--,--edit1_csection1--#----'.GetMessage("WZD_OPTION_5").'--,--PROPERTY_'.$arProperty["show_form"].'--#--'.GetMessage("WZD_OPTION_6").'--,--PROPERTY_'.$arProperty["phone"].'--#--'.GetMessage("WZD_OPTION_7").'--,--PROPERTY_'.$arProperty["phone_icon"].'--#--'.GetMessage("WZD_OPTION_8").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_9").'--,--PROPERTY_'.$arProperty["form_title"].'--#--'.GetMessage("WZD_OPTION_10").'--,--PROPERTY_'.$arProperty["form_subtitle"].'--#--'.GetMessage("WZD_OPTION_11").'--;--cedit1--#--'.GetMessage("WZD_OPTION_12").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_13").'--,--SORT--#--'.GetMessage("WZD_OPTION_14").'--,--CODE--#--'.GetMessage("WZD_OPTION_15").'--;--";}'));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("TIMELINE-BLOCK_IBLOCK_ID" => $iblockID));
