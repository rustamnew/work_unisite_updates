...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_2").'--;--cedit1--#--'.GetMessage("WZD_OPTION_3").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_4").'--,--SORT--#--'.GetMessage("WZD_OPTION_5").'--,--CODE--#--'.GetMessage("WZD_OPTION_6").'--;--";}'));
