...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_1").'--,--NAME--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["url"].'--#--'.GetMessage("WZD_OPTION_3").'--;--cedit1--#--'.GetMessage("WZD_OPTION_4").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_5").'--,--SORT--#--'.GetMessage("WZD_OPTION_6").'--,--CODE--#--'.GetMessage("WZD_OPTION_7").'--;--";}'));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("PARTNERS_IBLOCK_ID" => $iblockID));
