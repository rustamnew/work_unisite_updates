...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PROPERTY_'.$arProperty["title"].'--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["subtitle"].'--#--'.GetMessage("WZD_OPTION_3").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["features_show"].'--#--'.GetMessage("WZD_OPTION_5").'--,--edit1_csection1--#----'.GetMessage("WZD_OPTION_6").'--,--PROPERTY_'.$arProperty["features1_title"].'--#--'.GetMessage("WZD_OPTION_7").'--,--PROPERTY_'.$arProperty["features1_icon"].'--#--'.GetMessage("WZD_OPTION_8").'--,--PROPERTY_'.$arProperty["features1_description"].'--#--'.GetMessage("WZD_OPTION_9").'--,--edit1_csection2--#----'.GetMessage("WZD_OPTION_10").'--,--PROPERTY_'.$arProperty["features2_title"].'--#--'.GetMessage("WZD_OPTION_11").'--,--PROPERTY_'.$arProperty["features2_icon"].'--#--'.GetMessage("WZD_OPTION_12").'--,--PROPERTY_'.$arProperty["features2_description"].'--#--'.GetMessage("WZD_OPTION_13").'--,--edit1_csection3--#----'.GetMessage("WZD_OPTION_14").'--,--PROPERTY_'.$arProperty["features3_title"].'--#--'.GetMessage("WZD_OPTION_15").'--,--PROPERTY_'.$arProperty["features3_icon"].'--#--'.GetMessage("WZD_OPTION_16").'--,--PROPERTY_'.$arProperty["features3_description"].'--#--'.GetMessage("WZD_OPTION_17").'--,--edit1_csection4--#----'.GetMessage("WZD_OPTION_18").'--,--PROPERTY_'.$arProperty["features4_title"].'--#--'.GetMessage("WZD_OPTION_19").'--,--PROPERTY_'.$arProperty["features4_icon"].'--#--'.GetMessage("WZD_OPTION_20").'--,--PROPERTY_'.$arProperty["features4_description"].'--#--'.GetMessage("WZD_OPTION_21").'--,--edit1_csection5--#----'.GetMessage("WZD_OPTION_22").'--,--PROPERTY_'.$arProperty["video_show"].'--#--'.GetMessage("WZD_OPTION_23").'--,--PROPERTY_'.$arProperty["video_url"].'--#--'.GetMessage("WZD_OPTION_24").'--,--PROPERTY_'.$arProperty["video_background"].'--#--'.GetMessage("WZD_OPTION_25").'--;--cedit1--#--'.GetMessage("WZD_OPTION_26").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_27").'--,--SORT--#--'.GetMessage("WZD_OPTION_28").'--,--CODE--#--'.GetMessage("WZD_OPTION_29").'--;--";}'));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("FEATURES_IBLOCK_ID" => $iblockID));
