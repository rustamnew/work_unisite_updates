...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/stats.xml"; 
$iblockCode = "stats_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["icon"].'--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["icon_show"].'--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["url"].'--#--'.GetMessage("WZD_OPTION_5").'--,--PROPERTY_'.$arProperty["text"].'--#--'.GetMessage("WZD_OPTION_6").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_7").'--;--cedit1--#--'.GetMessage("WZD_OPTION_8").'--,--cedit1_csection1--#----'.GetMessage("WZD_OPTION_9").'--,--PROPERTY_'.$arProperty["stat1_title"].'--#--'.GetMessage("WZD_OPTION_10").'--,--PROPERTY_'.$arProperty["stat1_percent"].'--#--'.GetMessage("WZD_OPTION_11").'--,--cedit1_csection2--#----'.GetMessage("WZD_OPTION_12").'--,--PROPERTY_'.$arProperty["stat2_title"].'--#--'.GetMessage("WZD_OPTION_13").'--,--PROPERTY_'.$arProperty["stat2_percent"].'--#--'.GetMessage("WZD_OPTION_14").'--,--cedit1_csection3--#----'.GetMessage("WZD_OPTION_15").'--,--PROPERTY_'.$arProperty["stat3_title"].'--#--'.GetMessage("WZD_OPTION_16").'--,--PROPERTY_'.$arProperty["stat3_percent"].'--#--'.GetMessage("WZD_OPTION_17").'--,--cedit1_csection4--#----'.GetMessage("WZD_OPTION_18").'--,--PROPERTY_'.$arProperty["stat4_title"].'--#--'.GetMessage("WZD_OPTION_19").'--,--PROPERTY_'.$arProperty["stat4_percent"].'--#--'.GetMessage("WZD_OPTION_20").'--,--cedit1_csection5--#----'.GetMessage("WZD_OPTION_21").'--,--PROPERTY_'.$arProperty["stat5_title"].'--#--'.GetMessage("WZD_OPTION_22").'--,--PROPERTY_'.$arProperty["stat5_percent"].'--#--'.GetMessage("WZD_OPTION_23").'--;--cedit2--#--'.GetMessage("WZD_OPTION_24").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_25").'--,--SORT--#--'.GetMessage("WZD_OPTION_26").'--,--CODE--#--'.GetMessage("WZD_OPTION_27").'--;--";}'));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("STATS_IBLOCK_ID" => $iblockID));
