...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/features_under.xml"; 
$iblockCode = "features_under_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--PROPERTY_'.$arProperty["icon"].'--#--'.GetMessage("WZD_OPTION_1").'--,--NAME--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["title"].'--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["description"].'--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["link"].'--#--'.GetMessage("WZD_OPTION_5").'--;--cedit1--#--'.GetMessage("WZD_OPTION_6").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_7").'--,--SORT--#--'.GetMessage("WZD_OPTION_8").'--,--CODE--#--'.GetMessage("WZD_OPTION_9").'--;--";}'));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("FEATURES_UNDER_IBLOCK_ID" => $iblockID));
